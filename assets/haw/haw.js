(function ($) {
    ...
    function addOptionsToYearSelect() {
        ...
        var years = [
            { year: 2024, url: "chung-nhan-2024/index.html" },
            { year: 2023, url: "chung-nhan-2023.html" },
            { year: 2022, url: "chung-nhan-2022.html" },
            { year: 2021, url: "chung-nhan-2021.html" },
        ];

        for (var i = 0; i < years.length; i++) {
            var option = document.createElement("option");
            option.value = years[i].url;
            option.text = years[i].year;
            if (years[i].url == window.location.pathname) {
